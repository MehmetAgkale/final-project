                ...
                <div class="header-wrapper d-flex justify-content-between align-items-center flex-row">
                    ...
                    <div class="menu-list-wrapper">
                        <ul class="main-menu">
                            ...
                            <li class="links--wrap"><a class="link text--black" href="#">REZERVASYON</a></li>
                            <li class="links--wrap"><a class="link text--black" href="#">ÖĞRETMENLER</a></li>
                            <!-- <li><a class="link text--black" href="#">İLETİŞİM<Main></Main></a></li> -->
                            <li><a class="link text--black" href="#">MESAJLARIM</a></li>
                        </ul>
                    </div>
                    <ul class="login-lng d-flex align-items-center gap-3">
                        <?php if (isset($_SESSION['user_name'])): ?>
                            <li><span class="btn btn-outline--dark text--black border--black"><?php echo $_SESSION['user_name']; ?></span></li>
                        <?php else: ?>
                            <li><a class="btn btn-outline--dark text--black border--black" href="login.php">Giriş Yap</a></li>
                            <li><a class="btn btn-outline--dark text--black border--black" href="signin.html">Kayıt Ol</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
        ...
        <div class="offcanvas-body">
            <div class="user-info">
                <div class="user-thumb">
                    <a href="#"><img src="assets/images/user/user3.png" alt="user-thumb"></a>
                </div>
                <a href="#"><h4>Anonymous Alex</h4></a>
            </div>
            <div class="sidebar-menu position-relative">
                <ul class="sidebar-menu-list">
                    <li class="sidebar-menu-list__item"><a href="index.php" class="sidebar-menu-list__link active"><span class="icon"><i class="fa-solid fa-house"></i></span><span class="text">Home</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="about.html" class="sidebar-menu-list__link"><span class="icon"><i class="fa-regular fa-circle-question"></i></span><span class="text">About</span></a></li>
                    <li class="sidebar-menu-list__item has-dropdown"><a href="#" class="sidebar-menu-list__link"><span class="icon"><i class="fa-regular fa-compass"></i></span><span class="text">Menu</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="service.html" class="sidebar-menu-list__link"><span class="icon"><i class="fa-solid fa-arrow-right-arrow-left"></i></span><span class="text">Service</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="blog.html" class="sidebar-menu-list__link"><span class="icon"><i class="fa-solid fa-blog"></i></span><span class="text">Blog</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="contact.html" class="sidebar-menu-list__link"><span class="icon"><i class="fa-solid fa-headset"></i></span><span class="text">Contact</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="cart.html" class="sidebar-menu-list__link"><span class="icon"><i class="fa-brands fa-opencart"></i></span><span class="text">Cart</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="favorit.html" class="sidebar-menu-list__link"><span class="icon"><i class="fa-regular fa-heart"></i></span><span class="text">Favorite</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="login.php" class="sidebar-menu-list__link"><span class="icon"><i class="fa-solid fa-arrow-right-to-bracket"></i></span><span class="text">Login</span></a></li>
                    <li class="sidebar-menu-list__item"><a href="signin.html" class="sidebar-menu-list__link"><span class="icon"><i class="fa-solid fa-arrow-right-from-bracket"></i></span><span class="text">Signup</span></a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12 d-flex justify-content-center align-items-center">
                    <div class="hero-content--wrap d-flex flex-column gap--20 justify-content-center align-items-center">
                        <h1 class="text-center hero--title fw--400 wow animate__animated animate__fadeInUp splite-text" data-splitting data-wow-delay="0.2s"> Öğretenlerinizle Daha Kolay Görüşme Ayarlayın.</h1>
                        <p class="text-center hero--subtitle fs--18 wow animate__animated animate__fadeInUp" data-wow-delay="0.3s">Online rezervasyon sistemi sayesinde öğretmenlerinizle randevu almak çok daha kolay! Takvim kontrolüyle vakit kaybetmeden uygun saatleri görüntüleyin ve tıkla randevunuzu oluşturun.</p>
                        <div class="btn--wrap wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                            <button class="btn btn--base"><i class="fs--20 fa-solid fa-book-open"></i>Şimdi Rezervasyon Yap</button>
                        </div>
                    </div>
                </div> 
            </div>
                ...
                <div class="pt-100">
                    <div class="row gy-4 justify-content-center">
                        ...
                        <div class="col-xl-2 col-sm-6">
                            <div class="footer-item">
                                <h5 class="footer-item--title">Hızlı Linkler</h5>
                                <ul class="footer-menu">
                                    <li class="menu--item"><a href="voucher-details.html" class="menu--link text-white">Rezervasyon</a></li>
                                    <li class="menu--item"><a href="blog-details.html" class="menu--link text-white">Öğretmenler</a></li>
                                    <li class="menu--item"><a href="favorit.html" class="menu--link text-white">İletişim</a></li>
                                    <li class="menu--item"><a href="#" class="menu--link text-white">ChatGPT</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6">
